let frases = [
    ...
    "O rapido rapaz marrom saltou sobre a raposa preguiçosa.",
    "Trite tigre, triste tigre, que tristes tigres são os tigres tristes.",
    "Se voce for um bom menino, ganhara um doce.",
];
